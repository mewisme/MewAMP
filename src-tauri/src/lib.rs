...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::installer::install_sql_localdb_only,
            commands::installer::get_install_state,
            commands::installer::reset_install_state,
            commands::sql_localdb::get_sql_localdb_manifest_entries,
            commands::sql_localdb::sql_localdb_installer_supported,
            commands::sql_localdb::uninstall_app_managed_sql_localdb,
            commands::sql_localdb::sql_localdb_cli,
            commands::sql_localdb::list_sql_localdb_instances,
            commands::sql_localdb::sql_localdb_init_runtime,
            commands::sql_localdb::get_sql_localdb_instance_status,
